...
namespace twitch2tuner
{
    ...
    public class YtDlp : StreamUtility
    {
        ...
        {
            Process getStreamUrlProcess = base.StartProcess("yt-dlp", $"-q --no-warnings {channelUrl} --get-url");
        ...
        {
            Process ytDlpProcess = base.StartProcess("yt-dlp", $"-q --no-warnings {streamUrl} -o -");
            return ytDlpProcess;
        }
    ...
    public class Streamlink : StreamUtility
    {
        ...
        public override string GetStreamUrl(string channelUrl)
        {
            ...
            List<StreamUtilityArgument> arguments =
            [
                new StreamUtilityArgument(channelUrl),
                new StreamUtilityArgument(Config.StreamLinkQuality ?? "best"),
        ...
        public override Process StartStreamProcess(string streamUrl)
        {
            Process streamlinkProcess = base.StartProcess("streamlink", $"{streamUrl} {Config.StreamLinkQuality ?? "best"} --stdout --quiet");
